# Contributing to FormixUI

Thank you for your interest in contributing to FormixUI! We welcome contributions from the community.
...
2. Clone your fork:
   ...
   ```bash
   git clone https://github.com/YOUR_USERNAME/formix-ui.git
   cd formix-ui
   ```
...
- **Discord**: [Join our community](https://discord.gg/formix)
- **GitHub Discussions**: Ask questions
- **Stack Overflow**: Tag `formix-ui`
...
### Thank you for contributing to FormixUI! 🎉
