...
export default {
  content: [
    "./index.html",
    "./src/**/*.{js,ts,jsx,tsx}",
    "./node_modules/formstack-ui/**/*.{js,ts,jsx,tsx}", // Add this line
  ],
  theme: {
    extend: {},
  },
...
import { generateYupSchema } from "formstack-ui/utils/yup-validation";
...
import type { SchemaFormHandle, FormSchema } from 'formstack-ui';
...
```typescript
import { ThemeProvider, ThemeSwitcher, SchemaForm } from 'formstack-ui';
...
- **GitHub**: [formstack-ui](https://github.com/adarshatl03/form-engine)
- **npm**: [@formstack-ui](https://www.npmjs.com/package/formstack-ui)
